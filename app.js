...
let currentEnd = document.getElementsById('currentEnd');
let seek = document.createElementById('seek');
let bar2 = document.createElementById('bar2');
let dot = document.createElementByClassName('dot')[0];
...
music.addEventListener('timeupdate', () => {
    ...
    let progressbar = parseInt((music.currentTime/music.currentDuration) * 100);
